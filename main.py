...
async def getDistance(message):
    ...
    while invalid:
      ...
      if returnDist.isnumeric() and float(returnDist) > 0:
        ...
        await message.channel.send("Please enter a valid number as a distance.")
...
async def getRestOption(message):
    ...
    while invalid:
      ...
      if returnVal == "1":
        ...
        invalid = True
        await message.channel.send("Enter a valid number for what kind of restaurant you would like, please. (1) Delivery, (2) Takeout, (3) Dine-In(4) Any")
    return returnVal
...
async def getStars(message):
    ...
    while invalid:
      ...
      if stars=="1" or stars=="2" or stars=="3" or stars=="4" or stars=="5":
        ...
        await message.channel.send("Please enter a valid number of stars. 1-5")  
